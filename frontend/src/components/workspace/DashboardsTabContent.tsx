...
import CreateDashboardWizard from '../dashboard/CreateDashboardWizard';
...
export default function DashboardsTabContent({ workspaceId }: Props) {
  ...
  return (
    <div className="custom-scrollbar flex flex-1 flex-col overflow-y-auto bg-navy-50/40 px-6 py-5">
      <div className="mx-auto w-full max-w-7xl">
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
          <div>
            <h2 className="text-[18px] font-semibold tracking-tight text-navy-900">
              Dashboards
            </h2>
            <p className="text-[12.5px] text-navy-500">
              Curated, refreshable views over your data — published read-only to the workspace.
            </p>
          </div>
          {isPrivileged && (
            <button
...
/* ─── Card (mirror of DashboardsPage card) ─── */
